import { ArchiveOrUnarchiveNoteRequest, CreateNoteRequest, DeleteNoteRequest, DeleteNoteResponse, GetNotesRequest, Note, UpdateNoteRequest } from "src/entities/note";
